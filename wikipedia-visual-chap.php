...
<div id="wikipedia-visual-chap-admin-box" class="wrap">
	...
	<?php esc_html_e('Thank you for using Visual Chap, the smart, graphical companion for your posts! ', 'wikipedia-visual-chap');
        ?>
	<img id="wikipedia-visual-chap-admin-logo" src="<?php echo esc_url(plugins_url() . '/wikipedia-visual-chap/assets/img/Visual_Chap_logo.png'); ?>" alt="Visual Chap logo"></img>
    </p>
    <p>
	...
	<a style="text-decoration: none;" href="<?php echo esc_url('http://ypower.nouveausiteweb.fr/'); ?>" alt="<?php echo esc_attr__('Y power\'s website', 'wikipedia-visual-chap'); ?>" target="_blank"><img id="wikipedia-visual-chap-admin-dev-logo" src="<?php echo esc_attr( plugins_url() . '/wikipedia-visual-chap/assets/img/y_power_logo.png' ) ?>"></img></a>
    </div>
...
public function wikipedia_visual_chap_settings_link($actions, $file) {
    if (false !== strpos($file, 'wikipedia-visual-chap'))
