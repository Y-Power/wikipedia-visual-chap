...
*/
    ...
    $wvcHTMLInject = '<!-- Wikipedia Visual Chap START --><div id="wikipedia-visual-chap-box" class="wvc-box-standby"><div id="wikipedia-visual-chap-inner-container"><div id="wikipedia-visual-chap-box-switch" class="wvc-switch-standby"><img id="wikipedia-visual-chap-box-logo" src="' . esc_url(plugins_url() . '/wikipedia-visual-chap/assets/img/Visual_Chap_logo.png') . '" alt="visual chap logo"></img><i class="fa fa-wikipedia-w" aria-hidden="true"></i></div><p id="wikipedia-visual-chap-name" class="wikipedia-visual-chap-standby-item">Visual Chap</p><p class="wikipedia-visual-chap-standby-item">' . __('Click words or select text to get a quick link, a description and a picture from that Wikipedia<sup>&reg</sup> entry', 'wikipedia-visual-chap') . '</p><div class="wikipedia-visual-chap-standby-item" id="wikipedia-visual-chap-display"><div class="wvc-loading-image-standby" id="wikipedia-visual-chap-img-loading"><i class="fa fa-circle-o-notch fa-3x" aria-hidden="true"></i></div><a id="wikipedia-visual-chap-display-title-link" href="" target="_blank"><h3 id="wikipedia-visual-chap-display-title"></h3></a><p class="wikipedia-visual-chap-standby-item" id="wikipedia-visual-chap-display-description"></p><img class="wvc-img-standby" id="wikipedia-visual-chap-display-image" alt="" src=""/></div></div></div><!-- Wikipedia Visual Chap END -->' . $content;
